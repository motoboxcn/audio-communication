...
/*
PortAudio是一个跨平台音频I/O库，它不提供操作系统级别的音频设备管理功能。然而，你可以使用PortAudio的API在程序中选择特定的音频输入设备。对于需要使用蓝牙设备作为音频输入的应用程序，你首先需要获取所有音频设备的列表，然后选择蓝牙设备作为输入设备。此过程涉及到PortAudio API的使用，具体请参考PortAudio的官方文档。
*/
